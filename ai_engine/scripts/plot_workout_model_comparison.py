...
# Жаттығу (Workout) тестілерінен алынған нақты нәтижелер
results = {
...
plt.title("Жаттығу (Workout) моделін таңдау", fontsize=16, fontweight="bold")
...
plt.tight_layout()
output_path = OUTPUT_DIR / "workout_model_comparison_presentation.png"
