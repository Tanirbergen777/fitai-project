...
translations = {
    ...
    "kaz": {
        ...
        "mlOptimalPlan": "🏋️ Оңтайлы жоспар:",
        "timesPerWeek": "рет аптасына",
        "perWorkout": "⏱️ Бір жаттығу:",
        "min": "мин.",
        "burnAbout": "(шамамен",
        "kcal": "ккал жағу)",
        "mlBadVerdict": "⚠️ ML Үкімі: Тым жылдам! Қауіпсіздік үшін кем дегенде {{weeks}} апта ұсынамыз.",
        "mlHeavyPlan": "🏋️ Осы мерзімді қалдырсаңыз, мынадай жүктеме қажет:",
...
print("Translation files updated successfully with editModal keys.")
